"""
Script to add B610 product to the database
"""
...
product, created = Product.objects.get_or_create(
    slug='classic-stripe-sweatshirt-set-b610',
    defaults={
        'name': 'Classic Stripe Sweatshirt Set B610',
        'description': 'Classic stripe sweatshirt set featuring a comfortable two-tone sweatshirt with stripe detail and matching jogger pants with side logo. Perfect for everyday wear, playtime, or casual outings. Made with soft, breathable fabric for your little one\'s comfort.',
        'category': category,
        'base_price': Decimal('480.00'),
        'main_image': 'products/B610/navy_main.jpg',
        'is_active': True
    }
)
...
color_data = [
    {'name': 'Navy & Grey', 'hex': '#1C1C3C,#C0C0C0', 'img': 'navy_main.jpg'},
    {'name': 'Black & Grey', 'hex': '#000000,#C0C0C0', 'img': 'black.jpg'},
    {'name': 'Red & Navy', 'hex': '#DC143C,#1C1C3C', 'img': 'red.jpg'},
]
...
for color_info in color_data:
    ...
    img_path = f'products/B610/{color_info["img"]}'
...
print(f"\n[SUCCESS] Product B610 added with {len(color_data)} colors!")
